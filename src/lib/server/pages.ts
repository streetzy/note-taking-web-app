...
export async function update_page_name(section_id: string, page_id: string, _name: string) {
...
export async function notebook_section_pages(notebook_id: string, section_id: string) {
    ...
    const pages_info : { page_id: string, page_name: string, editorjs_content: {
        time: number,
        blocks: { type: String, data: Object }[],
        version: String,
    } | undefined
    }[] = sections_pages.map((page: { _id: string, name: string, editorjs_content: {
        time: number,
        blocks: { type: String, data: Object }[],
        version: String,
    } | undefined }) => {
