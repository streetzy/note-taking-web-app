...
<div class="content-container">
  ...
  >
    ...
    <div class="container name-container">
      <h4>Post name:</h4>
      <input type="text" class="post-name" name="post-name" required />
    </div>
    <div class="container description-container">
      <h4>Description:</h4>
      <textarea class="post-description" name="post-description" required
      ></textarea>
    </div>
    ...
    <div class="button-container">
      <button disabled={creating}>Create post</button>
    </div>
  </form>
</div>
